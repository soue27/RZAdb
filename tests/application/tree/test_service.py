...
@pytest.mark.asyncio
async def test_tree_service_builds_full_enterprise_tree() -> None:
...
@pytest.mark.asyncio
async def test_tree_service_starts_from_engineer_department() -> None:
    async with async_session_factory() as session:
        holding = Enterprise(
            type=EnterpriseType.HOLDING,
...
@pytest.mark.asyncio
async def test_tree_service_starts_from_specialist_branch() -> None:
    async with async_session_factory() as session:
        holding = Enterprise(
            type=EnterpriseType.HOLDING,
...
@pytest.mark.asyncio
async def test_tree_service_excludes_deleted_enterprises_and_substations() -> None:
    async with async_session_factory() as session:
        holding = Enterprise(
            type=EnterpriseType.HOLDING,
